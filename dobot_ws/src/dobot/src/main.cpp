...
// int systemInit(int argc, char **argv, ros::NodeHandle n)
// {
...
//     // Set infrared sensor
//     // client = n.serviceClient<dobot::SetInfraredSensor>("/InfraredServer/SetInfraredSensor");
...
int main(int argc, char **argv)
{
    ...
    Receiver = n.subscribe("InfraredChatter", 1000, chatterCallback);
